-- 1. Funções e Views (Usando CREATE OR REPLACE)
...
-- 2. Políticas de RLS (Usando DROP IF EXISTS e CREATE)
-- Perfis
...
-- 3. Exclusão e Recriação das Tabelas de Dados (ISSO APAGARÁ OS DADOS)
...
-- Recriação da tabela 'transactions'
